...
public:
	...
	static void CalculateTangent(glm::vec3& tangent, const glm::vec3& pv0, const glm::vec3& pv1, const glm::vec3& pv2, const glm::vec2& uv0, const glm::vec2& uv1, const glm::vec2& uv2, const glm::vec3& normal);
